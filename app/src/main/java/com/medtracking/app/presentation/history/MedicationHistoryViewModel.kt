...
import com.medtracking.app.domain.usecase.CalculateAdherenceForMedicationUseCase
import com.medtracking.app.domain.usecase.GetIntakeHistoryForMedicationUseCase
...
class MedicationHistoryViewModel @Inject constructor(
    ...
    private fun mapToAdherenceUi(result: com.medtracking.app.domain.model.AdherenceResult): AdherenceResultUi {
